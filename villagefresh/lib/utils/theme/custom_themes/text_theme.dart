...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w600, color: Colors.black),
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.w600, color: Colors.white),
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w600, color: Colors.white),
